def diamond_encoding_new(firstPixel,secondPixel,secret_data,embedding_parameter=5):
    #Embedding Parameter
...
def diamondDecode(first_pixel,second_pixel,embedding_parameter=5,final_ans=''):
    z=embedding_parameter
    lw= (2*z*z + 2*z + 9)
    g1=first_pixel
    h1=second_pixel
